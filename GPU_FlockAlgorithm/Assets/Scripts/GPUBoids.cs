...
public class GPUBoids : MonoBehaviour
{
    ...
    [Header("최대 개체 수")]
    // 최대 개체 수
    [SerializeField, Range(10, 32768)] private int maxObjectNum = 256;
    ...
    private void FlockingBehavior()
    {
        ...
        Debug.Log(id);
        cs.SetInt("_Test", test);
        Debug.Log(test);
        cs.SetBuffer(id, "_testBuffer", _testBuffer);
